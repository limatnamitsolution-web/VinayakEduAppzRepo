...
{
    public class CreateMasterConfigHandler : IRequestHandler<CreateMasterConfigCommand, MasterConfigResponse>
    {
        private readonly IMasterConfigRepository _repo;

        public CreateMasterConfigHandler(IMasterConfigRepository repo) => _repo = repo;

        public async Task<MasterConfigResponse> Handle(CreateMasterConfigCommand request, CancellationToken cancellationToken)
        {
